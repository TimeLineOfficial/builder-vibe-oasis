...
export const extendedInterestDataset: ExtendedInterest[] = [
  ...
  { 
    ...
    subcategory: 'AI/ML',
    trending: true, 
    keywords: ['AI', 'ML', 'deep learning', 'neural networks', 'tensorflow', 'pytorch'], 
    related_skills: ['Python', 'TensorFlow', 'PyTorch', 'Statistics', 'Linear Algebra'], 
    career_paths: ['AI Engineer', 'Data Scientist', 'ML Researcher', 'AI Product Manager'], 
  ...
  { 
    ...
    trending: true, 
    keywords: ['blockchain', 'cryptocurrency', 'smart contracts', 'web3', 'defi'], 
  ...
  { 
    ...
    trending: true, 
    keywords: ['security', 'hacking', 'penetration testing', 'ethical hacking', 'infosec'], 
    related_skills: ['Ethical Hacking', 'Network Security', 'Cryptography', 'Forensics'], 
    career_paths: ['Security Analyst', 'Ethical Hacker', 'CISO', 'Security Consultant'], 
    education_levels: ['BTech', 'Certification'], 
    growth_potential: 'high', 
  ...
  { 
    ...
    career_paths: ['Quantum Researcher', 'Quantum Engineer', 'Quantum Software Developer'], 
  ...
  { 
    ...
    career_paths: ['IoT Developer', 'Embedded Systems Engineer', 'Hardware Engineer'], 
  ...
  { 
    ...
    career_paths: ['Genetic Engineer', 'Research Scientist', 'Biotech Consultant'], 
  ...
  { 
    ...
    career_paths: ['Telemedicine Doctor', 'Health Tech Specialist', 'Digital Health Consultant'], 
  ...
  { 
    ...
    career_paths: ['Medical AI Specialist', 'Diagnostic Engineer', 'Radiologist'], 
  ...
  { 
    ...
    career_paths: ['Biomedical Engineer', 'Medical Device Designer', 'Clinical Engineer'], 
    education_levels: ['BTech', 'MTech'], 
    growth_potential: 'high', 
  ...
  { 
    ...
    career_paths: ['Space Engineer', 'Mission Specialist', 'Satellite Engineer'], 
    education_levels: ['BTech', 'MTech'], 
    growth_potential: 'high', 
  ...
  { 
    ...
    career_paths: ['Robotics Engineer', 'Automation Specialist', 'AI Robotics Engineer'], 
  ...
  { 
    ...
    career_paths: ['Aerospace Engineer', 'Aircraft Designer', 'Flight Test Engineer'], 
    education_levels: ['BTech', 'MTech'], 
  ...
  { 
    ...
    career_paths: ['VR Developer', 'AR Designer', 'Immersive Experience Designer'], 
    education_levels: ['BTech', 'Diploma'], 
    growth_potential: 'high', 
    salary_range: '₹4-20 LPA' 
  },
  ...
  { 
    ...
    related_skills: ['Financial Analysis', 'Risk Management', 'Market Research'], 
  ...
  { 
    ...
    career_paths: ['Investment Banker', 'Financial Analyst', 'Corporate Finance'], 
    education_levels: ['BCom', 'MBA'], 
    growth_potential: 'high', 
  ...
  { 
    ...
    career_paths: ['Marine Biologist', 'Ocean Researcher', 'Conservation Scientist'], 
  ...
  { 
    ...
    career_paths: ['Climate Scientist', 'Environmental Consultant', 'Meteorologist'], 
    education_levels: ['BSc', 'MSc', 'PhD'], 
    growth_potential: 'high', 
    salary_range: '₹4-18 LPA' 
  },
  ...
  { 
    ...
    career_paths: ['Cyber Lawyer', 'Privacy Consultant', 'Legal Tech Specialist'], 
  ...
  { 
    ...
    career_paths: ['Forensic Scientist', 'Crime Investigator', 'Digital Forensics Expert'], 
    education_levels: ['BSc', 'MSc'], 
    growth_potential: 'medium', 
  ...
  { 
    ...
    career_paths: ['Special Education Teacher', 'Therapist', 'Educational Consultant'], 
    education_levels: ['BEd', 'MEd'], 
    growth_potential: 'medium', 
  ...
  { 
    ...
    career_paths: ['AgTech Specialist', 'Farm Manager', 'Agricultural Engineer'], 
  ...
  { 
    ...
    career_paths: ['Food Scientist', 'Quality Assurance Manager', 'Nutritionist'], 
    education_levels: ['BSc', 'MSc'], 
    growth_potential: 'medium', 
...
export const searchInterests = (query: string): ExtendedInterest[] => {
  ...
  return extendedInterestDataset.filter(interest => 
    interest.name.toLowerCase().includes(searchQuery) ||
    interest.category.toLowerCase().includes(searchQuery) ||
    interest.keywords.some(keyword => keyword.toLowerCase().includes(searchQuery)) ||
    interest.related_skills.some(skill => skill.toLowerCase().includes(searchQuery))
  );
};

// Helper function to get interests by category
export const getInterestsByCategory = (): Record<string, ExtendedInterest[]> => {
  return extendedInterestDataset.reduce((acc, interest) => {
