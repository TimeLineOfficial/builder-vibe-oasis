...
export default function Index() {
  ...
  useEffect(() => {
    ...
    const timer = setInterval(() => {
      currentStep++;
      setAnimatedNumbers({
        jobsListed: Math.min(Math.floor(increments.jobsListed * currentStep), targets.jobsListed),
        businessIdeas: Math.min(Math.floor(increments.businessIdeas * currentStep), targets.businessIdeas),
        successStories: Math.min(Math.floor(increments.successStories * currentStep), targets.successStories),
  ...
  const jobsFeatures = [
    {
      icon: Target,
      title: "By Goal",
      description: "Interactive career roadmap from your current stage to dream job",
    ...
    },
    {
      icon: Heart,
      title: "By Interest",
      description: "Discover careers based on your passions and subjects you love",
    ...
    },
    {
      ...
      description: "Real-time government and private job openings with application guides",
  ...
  const businessFeatures = [
    {
      ...
      description: "Categorized business opportunities with complete startup guides",
    ...
    },
    {
      ...
      description: "Required permits, licenses, and legal documentation guidance",
    ...
    },
    {
      ...
      description: "Investment requirements and projected returns for each business",
  ...
  const trendingJobs = [
    { title: "Software Developer", category: "Technology", applications: "2.5K+", deadline: "15 Dec" },
    { title: "Digital Marketing", category: "Marketing", applications: "1.8K+", deadline: "20 Dec" },
    { title: "Data Analyst", category: "Analytics", applications: "3.2K+", deadline: "18 Dec" },
    { title: "Content Creator", category: "Creative", applications: "950+", deadline: "25 Dec" }
  ];

  const trendingBusiness = [
    { title: "E-commerce Store", category: "Retail", investment: "₹50K-2L", roi: "25-40%" },
    { title: "Food Delivery", category: "Food & Beverage", investment: "₹1L-5L", roi: "20-35%" },
    { title: "Digital Agency", category: "Services", investment: "₹25K-1L", roi: "30-50%" },
    { title: "Ed-Tech Platform", category: "Education", investment: "₹2L-10L", roi: "40-60%" }
  ];
          ...
          <div className="max-w-4xl mx-auto text-center space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-xl md:text-2xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
                From school to success - discover your perfect career path, explore business opportunities, 
                and get step-by-step guidance to achieve your professional dreams.
              </p>
            </div>

            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button size="lg" className="bg-gradient-to-r from-career-primary to-career-secondary hover:opacity-90 text-lg px-8 py-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 pt-12">
              ...
              <div className="text-center">
                ...
                <div className="text-sm text-muted-foreground">Business Ideas</div>
              </div>
              <div className="text-center">
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center space-y-4 mb-16">
              <div className="flex items-center justify-center gap-2 mb-4">
                ...
                <h2 className="text-4xl md:text-5xl font-bold">Career Guidance</h2>
              </div>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center space-y-4 mb-16">
              <div className="flex items-center justify-center gap-2 mb-4">
                ...
                <h2 className="text-4xl md:text-5xl font-bold">Business Opportunities</h2>
              </div>
              <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
                Start your entrepreneurial journey with complete guidance and support
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {businessFeatures.map((feature, index) => (
                <Card key={index} className="group relative overflow-hidden border-0 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
                  ...
                  <CardHeader className="relative">
                    <div className={`p-3 rounded-xl bg-gradient-to-br ${feature.color} text-white w-fit mb-4`}>
                      <feature.icon className="h-6 w-6" />
                    </div>
        ...
        <div className="container px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-4xl md:text-5xl font-bold mb-4">What's Trending</h2>
                    ...
                    <Card key={index} className="hover:shadow-md transition-shadow">
                      <CardContent className="p-4">
                        <div className="flex items-center justify-between">
                          <div className="flex-1">
                            <div className="flex items-center gap-2 mb-1">
                              <h4 className="font-semibold">{business.title}</h4>
                              <Badge variant="outline" className="text-xs">
                                {business.category}
                              </Badge>
                            </div>
        ...
        <div className="container px-4">
          <div className="max-w-4xl mx-auto text-center text-white space-y-8">
            ...
            <p className="text-xl opacity-90 max-w-2xl mx-auto">
              Join thousands of students and professionals who have already found their path to success. 
