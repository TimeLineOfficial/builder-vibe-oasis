...
import { ArrowRight, BookOpen, Target, Award, Clock, Users, Star, CheckCircle, ExternalLink, PlayCircle } from 'lucide-react';
...
interface CareerStep {
  ...
  exams?: string[];
  nextSteps?: string[];
  resources?: { title: string; type: 'link' | 'video' | 'course'; url?: string }[];
  isCompleted?: boolean;
  isActive?: boolean;
...
export default function DynamicCareerMap({ currentStage, goal, onPathGenerated }: CareerMapProps) {
    ...
    'class_11_12_pcm_engineer': [
      {
        ...
        duration: '2 years',
        requirements: ['Strong conceptual understanding', 'Regular practice', 'NCERT mastery'],
        difficulty: 'Medium',
        importance: 'Critical',
        resources: [
        ...
        nextSteps: ['JEE Main preparation', 'State CET preparation', 'Board exam focus']
      },
      {
        id: 'step_2',
        title: 'Engineering Entrance Preparation',
        description: 'Intensive preparation for JEE Main/Advanced and state CETs',
        duration: '1-2 years',
        requirements: ['12th PCM completed', 'Coaching/self-study plan', 'Mock test practice'],
        exams: ['JEE Main', 'JEE Advanced', 'MHT CET', 'BITSAT', 'VITEEE', 'COMEDK'],
        ...
        nextSteps: ['College selection', 'Branch preference', 'Counselling process']
      },
      {
        id: 'step_3',
        title: 'BTech Specialization Selection',
        description: 'Choose engineering branch based on interests and market demand',
        duration: '4 years',
        requirements: ['JEE/CET qualification', 'College admission', 'Branch allocation'],
        difficulty: 'Medium',
        importance: 'High',
        options: [
        ...
        nextSteps: ['Academic excellence', 'Practical projects', 'Internship preparation']
      },
      {
        id: 'step_4',
        title: 'Skill Development & Projects',
        description: 'Build technical skills and create impressive project portfolio',
        duration: '2-3 years (during BTech)',
        requirements: ['Programming fundamentals', 'Domain knowledge', 'Project ideas'],
        difficulty: 'Medium',
        importance: 'High',
        options: [
        ...
        nextSteps: ['Internship applications', 'Job preparation', 'Higher studies planning']
      },
      {
        id: 'step_5',
    ...
    'class_11_12_pcb_doctor': [
      {
        ...
        duration: '2 years',
        requirements: ['Deep understanding of concepts', 'Diagram practice', 'Regular revision'],
        difficulty: 'Hard',
        importance: 'Critical',
        resources: [
        ...
        nextSteps: ['NEET preparation strategy', 'Mock test series', 'Conceptual clarity']
      },
      {
        id: 'step_2',
        title: 'NEET Preparation & Qualification',
        description: 'Clear National Eligibility cum Entrance Test for medical admission',
        duration: '1-2 years',
        requirements: ['12th PCB completed', 'NEET registration', 'Systematic preparation'],
        ...
        nextSteps: ['College selection', 'Counselling process', 'Seat allocation']
      },
      {
        id: 'step_3',
        ...
        requirements: ['NEET qualification', 'Medical college admission', 'Academic excellence'],
        difficulty: 'Hard',
        importance: 'Critical',
        options: [
        ...
        nextSteps: ['Internship completion', 'Medical registration', 'Career path selection']
      },
      {
        id: 'step_4',
        ...
        requirements: ['MBBS completion', 'Internship certificate', 'Medical Council registration'],
        difficulty: 'Medium',
        importance: 'Critical',
        options: [
          'General Practice',
        ...
        nextSteps: ['Specialization decision', 'Practice growth', 'Continuous learning']
      },
      {
        id: 'step_5',
        ...
        duration: '3-5 years',
        requirements: ['Medical practice experience', 'NEET PG (for specialization)', 'Professional network'],
        difficulty: 'Hard',
        importance: 'High',
        options: [
    ...
    'class_11_12_commerce_business': [
      {
        ...
        description: 'Master Accountancy, Business Studies, Economics with 85%+ marks',
        duration: '2 years',
        requirements: ['Strong foundation in commerce', 'Practical knowledge', 'Case study analysis'],
        difficulty: 'Medium',
        importance: 'High',
        resources: [
        ...
        nextSteps: ['Bachelor degree selection', 'Entrance exam preparation', 'Career planning']
      },
      {
        id: 'step_2',
        ...
        duration: '3 years',
        requirements: ['12th Commerce completed', 'College admission', 'Academic focus'],
        difficulty: 'Medium',
        importance: 'High',
        options: [
        ...
        nextSteps: ['Professional course planning', 'Internship preparation', 'Skill development']
      },
      {
        id: 'step_3',
        title: 'Professional Certification & Experience',
        description: 'Pursue professional courses and gain practical experience',
        duration: '2-4 years',
        requirements: ['Bachelor degree progress', 'Professional course enrollment', 'Practical training'],
        difficulty: 'Hard',
        importance: 'High',
        options: [
        ...
        nextSteps: ['Job market entry', 'MBA preparation', 'Entrepreneurship planning']
      },
      {
        id: 'step_4',
        ...
        duration: '1-3 years',
        requirements: ['Degree completion', 'Professional qualification', 'Work experience'],
        difficulty: 'Medium',
        importance: 'High',
        options: [
        ...
        nextSteps: ['MBA admission', 'Career advancement', 'Leadership development']
      }
    ],
    ...
    'class_11_12_arts_creative': [
      {
        ...
        description: 'Build strong base in chosen arts subjects and creative skills',
        duration: '2 years',
        requirements: ['Arts subject mastery', 'Portfolio development', 'Creative projects'],
        difficulty: 'Medium',
        importance: 'High',
        resources: [
        ...
        nextSteps: ['Portfolio preparation', 'Entrance exam preparation', 'Skill specialization']
      },
      {
        id: 'step_2',
        ...
        duration: '3-4 years',
        requirements: ['12th Arts completed', 'Portfolio/entrance exam', 'Creative aptitude'],
        difficulty: 'Medium',
        importance: 'High',
        options: [
        ...
        nextSteps: ['Skill enhancement', 'Industry exposure', 'Network building']
      },
      {
        id: 'step_3',
        ...
        duration: '1-2 years',
        requirements: ['Basic education completed', 'Software proficiency', 'Industry awareness'],
        difficulty: 'Medium',
        importance: 'High',
        options: [
        ...
        nextSteps: ['Portfolio building', 'Client acquisition', 'Career establishment']
      }
    ],
    ...
    'working_professional_tech_transition': [
      {
        ...
        description: 'Evaluate transferable skills and identify technology learning path',
        duration: '2-4 weeks',
        requirements: ['Current role analysis', 'Market research', 'Goal setting'],
        difficulty: 'Easy',
        importance: 'Critical',
        resources: [
        ...
        nextSteps: ['Learning path design', 'Resource allocation', 'Timeline planning']
      },
      {
        id: 'step_2',
        ...
        requirements: ['Learning schedule', 'Practice environment', 'Progress tracking'],
        difficulty: 'Hard',
        importance: 'Critical',
        options: [
        ...
        nextSteps: ['Project portfolio', 'Networking', 'Job search preparation']
      },
      {
        id: 'step_3',
        title: 'Portfolio Development & Job Search',
        description: 'Create impressive portfolio and start job hunting process',
        duration: '3-6 months',
        requirements: ['Completed projects', 'GitHub profile', 'Professional network'],
        difficulty: 'Medium',
        importance: 'Critical',
        options: [
  ...
  const generateCareerPath = (stage: string, goal: string): CareerStep[] => {
    ...
    if (stageLower.includes('11_12') || stageLower.includes('class_11')) {
      if (goalLower.includes('engineer') || goalLower.includes('technology') || 
          goalLower.includes('computer') || goalLower.includes('software')) {
    ...
    if (stageLower.includes('11_12') || stageLower.includes('class_11')) {
      if (goalLower.includes('doctor') || goalLower.includes('medical') || 
          goalLower.includes('mbbs') || goalLower.includes('physician')) {
    ...
    if (stageLower.includes('11_12') || stageLower.includes('class_11')) {
      if (goalLower.includes('business') || goalLower.includes('finance') || 
          goalLower.includes('commerce') || goalLower.includes('management')) {
    ...
    // Arts Stream paths
    if (stageLower.includes('11_12') || stageLower.includes('class_11')) {
      if (goalLower.includes('arts') || goalLower.includes('creative') || 
          goalLower.includes('design') || goalLower.includes('media')) {
    ...
    if (stageLower.includes('working') || stageLower.includes('professional')) {
      if (goalLower.includes('tech') || goalLower.includes('software') || 
          goalLower.includes('data') || goalLower.includes('programming')) {
        ...
        return [
          {
            ...
            description: 'Select Physics, Chemistry, Biology with Mathematics/English',
            duration: '1 year decision + 2 years study',
            requirements: ['10th pass with good marks in Science', 'Interest in biological sciences'],
            difficulty: 'Medium',
            importance: 'Critical',
        ...
        return [
          {
            ...
            description: 'Select Physics, Chemistry, Mathematics with additional subjects',
            duration: '1 year decision + 2 years study',
            requirements: ['10th pass with strong Math & Science', 'Logical thinking ability'],
            difficulty: 'Medium',
            importance: 'Critical',
    ...
    return [
      {
        ...
        duration: '2-4 weeks',
        requirements: ['Self assessment', 'Goal clarification', 'Market research'],
        difficulty: 'Easy',
        importance: 'Critical',
        resources: [
      ...
      },
      {
        ...
        duration: '1-2 weeks',
        requirements: ['Clear goals', 'Resource identification', 'Timeline creation'],
        difficulty: 'Medium',
        importance: 'High',
        resources: [
      ...
      },
      {
        ...
        description: 'Begin systematic skill development and knowledge acquisition',
      ...
      },
      {
        ...
        description: 'Put learning into practice and pursue career opportunities',
        duration: '3-12 months',
        requirements: ['Acquired skills', 'Portfolio/certificates', 'Professional network'],
        difficulty: 'Medium',
        importance: 'Critical',
        options: [
          'Job Applications',
  ...
  const getDifficultyColor = (difficulty?: string) => {
    switch (difficulty) {
      ...
      case 'Very Hard': return 'bg-red-100 text-red-800 dark:bg-red-900/20 dark:text-red-400';
    ...
    <div className="space-y-8">
      <div className="text-center mb-8">
        ...
        <p className="text-lg text-gray-600 dark:text-gray-300 mb-2">
          <span className="font-semibold text-blue-600">{currentStage.replace('_', ' ')}</span> 
          {' → '}
              ...
              <CardHeader className="pb-4">
                <div className="flex items-start justify-between">
                  ...
                  <div className="flex flex-col gap-2 ml-4">
                    ...
                    {step.importance && (
                      <Badge className={`text-xs ${getImportanceColor(step.importance)}`}>
                        {step.importance}
                      </Badge>
                    )}
                  </div>
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                      {step.options.map((option, i) => (
                        <Badge key={i} variant="secondary" className="text-xs p-2 justify-start">
                          {option}
                        </Badge>
                      ))}
                    </div>
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2">
                      {step.resources.map((resource, i) => (
                        <div key={i} className="flex items-center gap-2 p-2 bg-gray-50 dark:bg-gray-700 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors cursor-pointer">
                          ...
                          {resource.type === 'course' && <BookOpen className="w-4 h-4 text-green-600" />}
                          <span className="text-xs text-gray-700 dark:text-gray-300">{resource.title}</span>
                        </div>
                      ))}
                    </div>
                  </div>
        ...
        <div className="grid md:grid-cols-2 gap-4 text-sm">
          <div className="space-y-2">
            <p className="flex items-start gap-2">
              ...
              <span className="text-gray-700 dark:text-gray-300">Stay consistent with daily learning</span>
            </p>
            <p className="flex items-start gap-2">
              <CheckCircle className="w-4 h-4 text-green-600 mt-0.5" />
              <span className="text-gray-700 dark:text-gray-300">Build a strong professional network</span>
            </p>
            <p className="flex items-start gap-2">
              <CheckCircle className="w-4 h-4 text-green-600 mt-0.5" />
              <span className="text-gray-700 dark:text-gray-300">Create practical projects and portfolio</span>
            </p>
          </div>
          <div className="space-y-2">
            <p className="flex items-start gap-2">
              <CheckCircle className="w-4 h-4 text-green-600 mt-0.5" />
              <span className="text-gray-700 dark:text-gray-300">Seek mentorship and guidance</span>
            </p>
            <p className="flex items-start gap-2">
              <CheckCircle className="w-4 h-4 text-green-600 mt-0.5" />
              <span className="text-gray-700 dark:text-gray-300">Stay updated with industry trends</span>
            </p>
            <p className="flex items-start gap-2">
              <CheckCircle className="w-4 h-4 text-green-600 mt-0.5" />
              <span className="text-gray-700 dark:text-gray-300">Track progress and celebrate milestones</span>
            </p>
          </div>
        </div>
      </div>
